...
class _ControlsBarState extends State<ControlsBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final position = widget.controller.videoPlayerController.value.position.inSeconds.toDouble();
    final total = widget.controller.videoPlayerController.value.duration.inSeconds.toDouble();
    final value = min(_dragValue ?? position, total);
    final isLive = widget.video.isLive;
    return Builder(
      builder: (context) {
        if(_showControls) {
