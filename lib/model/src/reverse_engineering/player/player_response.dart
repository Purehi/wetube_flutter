...
class PlayerResponse {
  ...
  late final String playabilityStatusReason =
  root.get('playabilityStatus')!.getT<String>('reason')!;

  String get playabilityStatusErrorScreen {
    final errorScreen = root.get('playabilityStatus')!.getT<Map<String, dynamic>>('errorScreen')!;
    final playerErrorMessageRenderer = errorScreen['playerErrorMessageRenderer'];
    final subreason = playerErrorMessageRenderer?['subreason'];
    final List<dynamic>? runs = subreason?['runs'];
    String text = '';
