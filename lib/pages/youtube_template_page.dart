...
class YoutubeTemplatePage extends StatefulWidget {
  const YoutubeTemplatePage(this.videoPlayerController, {super.key, required this.video});
  final Video video;
  final VideoPlayerController? videoPlayerController;

  @override
  State<YoutubeTemplatePage> createState() => _YoutubeTemplatePageState();
}

class _YoutubeTemplatePageState extends State<YoutubeTemplatePage> {
                              ...
                              children: [
                                Stack(
                                  ...
                                  children: [
                                    ...
                                    if(_video?.timestampStyle != 'UPCOMING')CircularProgressIndicator(color: Color(0xff42C83C),)
                                    else
                                      Positioned(
                                          right: 4,
                                          bottom: 4,
