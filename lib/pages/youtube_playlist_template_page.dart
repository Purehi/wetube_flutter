...
import '../components/popup_video_player.dart';
...
class YoutubePlaylistTemplatePage extends StatefulWidget {
  const YoutubePlaylistTemplatePage(this.videoPlayerController, {super.key, required this.video});
  final Video video;
  final VideoPlayerController? videoPlayerController;

  @override
  State<YoutubePlaylistTemplatePage> createState() => _YoutubePlaylistTemplatePageState();
}

class _YoutubePlaylistTemplatePageState extends State<YoutubePlaylistTemplatePage> {
  ...
  void initState() {
    _pip = Floating();
    _video = widget.video;
    _isShow = _video?.playlistInfo != null;
  ...
  void _getYoutubeLinkSuccessListener(){
    getYoutubeLinkSuccess.addListener(() {
      ...
      if(value != null){
        ...
        if(link != null && _video?.videoId == value.keys.firstOrNull){
